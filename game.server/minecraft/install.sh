...
curl 'https://launcher.mojang.com/v1/objects/c8f83c5655308435b3dcf03c06d9fe8740a77469/server.jar' -o 'minecraft_server.jar' # vanialla aminecraft
java -Xmx4G -Xms4G -jar ./minecraft_server.jar nogui # first execution will fail
